...
#endif
#define FMI
#define MODEL_IDENTIFIER         12_VectorControl_
#define MODEL_IDENTIFIER_STRING "12_VectorControl_"
#endif
...
#define AME_NBOF_EXPLICIT_STATE     12
...
#define AME_NBOF_SOLVER_STATES      12

#define AME_NBOF_PARAMS             190
#define AME_NBOF_REAL_PARAMS        127
#define AME_NBOF_INT_PARAMS         34
#define AME_NBOF_TEXT_PARAMS        3
#define AME_NBOF_CSTATE_PARAMS      12
#define AME_NBOF_DSTATE_PARAMS      2
#define AME_NBOF_FIXED_VAR_PARAMS   12

#define AME_NBOF_VARS               155
#define AME_NBOF_INPUTS             0
#define AME_NBOF_OUTPUTS            0

#define AME_NBOF_REAL_STORES        35
#define AME_NBOF_INT_STORES         52
...
#define NB_SUBMODELNAME       20
static const char* GsubmodelNameArray[NB_SUBMODELNAME] = {
     "EMDSCIMFOC01 instance 1"
   , "EBCT00 instance 1"
   , "EBCT00 instance 2"
   , "EBCT00 instance 3"
   , "ESCAVINV001 instance 1"
   , "THTS1 instance 1"
   , "CONS00 instance 1"
   , "EBVT01 instance 1"
   , "GA00 instance 1"
...
static const S_AMEParamInfo GParamInfo[190] = {
   ...
   , {E_FixedVar_Param       , E_Expression_Param, 0, 4, 0, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 0, 11, 0, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 1, 16, 0, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 2, 22, 0, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 3, 24, 0, 0}
   , {E_Real_Param           , E_Expression_Param, 15, -1, 1, 0}
   , {E_Real_Param           , E_Expression_Param, 16, -1, 1, 0}
   , {E_Int_Param            , E_Expression_Param, 6, -1, 1, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 1, 41, 1, 0}
   , {E_Real_Param           , E_Expression_Param, 17, -1, 2, 0}
   , {E_Real_Param           , E_Expression_Param, 18, -1, 2, 0}
   , {E_Int_Param            , E_Expression_Param, 7, -1, 2, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 2, 47, 2, 0}
   , {E_Real_Param           , E_Expression_Param, 19, -1, 3, 0}
   , {E_Real_Param           , E_Expression_Param, 20, -1, 3, 0}
   , {E_Int_Param            , E_Expression_Param, 8, -1, 3, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 3, 53, 3, 0}
   , {E_Real_Param           , E_Expression_Param, 21, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 22, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 23, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 24, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 25, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 26, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 27, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 28, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 29, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 30, -1, 4, 0}
   , {E_Real_Param           , E_Expression_Param, 31, -1, 4, 0}
   , {E_Int_Param            , E_Expression_Param, 9, -1, 4, 0}
   , {E_Int_Param            , E_Expression_Param, 10, -1, 4, 0}
   ...
   , {E_Text_Param           , E_Expression_Param, 0, -1, 4, 0}
   , {E_Text_Param           , E_Expression_Param, 1, -1, 4, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 4, 55, 5, 0}
   , {E_Real_Param           , E_Expression_Param, 32, -1, 6, 1}
   , {E_DiscreteState_Param  , E_Expression_Param, 0, 88, 6, 0}
   , {E_Real_Param           , E_Expression_Param, 33, -1, 7, 0}
   , {E_Real_Param           , E_Expression_Param, 34, -1, 7, 0}
   , {E_Int_Param            , E_Expression_Param, 16, -1, 7, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 5, 92, 7, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 6, 89, 7, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 7, 95, 7, 0}
   , {E_Real_Param           , E_Expression_Param, 35, -1, 8, 1}
   , {E_DiscreteState_Param  , E_Expression_Param, 1, 96, 8, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 8, 97, 9, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 9, 100, 10, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 10, 101, 10, 0}
   , {E_FixedVar_Param       , E_Expression_Param, 11, 103, 11, 0}
   ...
   , {E_Real_Param           , E_Expression_Param, 49, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 50, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 51, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 52, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 53, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 54, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 55, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 56, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 57, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 58, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 59, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 60, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 61, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 62, -1, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 63, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 17, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 18, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 19, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 20, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 21, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 22, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 23, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 24, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 25, -1, 12, 0}
   , {E_Int_Param            , E_Expression_Param, 26, -1, 12, 0}
   , {E_Text_Param           , E_Expression_Param, 2, -1, 12, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 4, 115, 12, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 5, 117, 12, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 6, 119, 12, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 7, 120, 12, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 8, 121, 12, 0}
   , {E_Real_Param           , E_Expression_Param, 64, -1, 13, 0}
   , {E_Real_Param           , E_Expression_Param, 65, -1, 14, 0}
   , {E_Real_Param           , E_Expression_Param, 66, -1, 14, 0}
   , {E_Real_Param           , E_Expression_Param, 67, -1, 14, 0}
   , {E_Real_Param           , E_Expression_Param, 68, -1, 14, 0}
   , {E_Int_Param            , E_Expression_Param, 27, -1, 14, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 9, 134, 14, 0}
   , {E_Real_Param           , E_Expression_Param, 69, -1, 15, 0}
   , {E_Real_Param           , E_Expression_Param, 70, -1, 15, 0}
   , {E_Real_Param           , E_Expression_Param, 71, -1, 15, 0}
   , {E_Real_Param           , E_Expression_Param, 72, -1, 15, 0}
   , {E_Int_Param            , E_Expression_Param, 28, -1, 15, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 10, 142, 15, 0}
   , {E_Real_Param           , E_Expression_Param, 73, -1, 16, 0}
   , {E_Real_Param           , E_Expression_Param, 74, -1, 16, 0}
   , {E_ContinuousState_Param, E_Expression_Param, 11, 147, 16, 0}
   , {E_Real_Param           , E_Expression_Param, 75, -1, 17, 0}
   , {E_Real_Param           , E_Expression_Param, 76, -1, 17, 0}
   , {E_Int_Param            , E_Expression_Param, 29, -1, 17, 0}
   , {E_Real_Param           , E_Expression_Param, 77, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 78, -1, 18, 0}
   ...
   , {E_Real_Param           , E_Expression_Param, 94, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 95, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 96, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 97, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 98, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 99, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 100, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 101, -1, 18, 0}
   , {E_Int_Param            , E_Expression_Param, 30, -1, 18, 0}
   , {E_Int_Param            , E_Expression_Param, 31, -1, 18, 0}
   , {E_Real_Param           , E_Expression_Param, 102, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 103, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 104, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 105, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 106, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 107, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 108, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 109, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 110, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 111, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 112, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 113, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 114, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 115, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 116, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 117, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 118, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 119, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 120, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 121, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 122, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 123, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 124, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 125, -1, 19, 0}
   , {E_Real_Param           , E_Expression_Param, 126, -1, 19, 0}
   , {E_Int_Param            , E_Expression_Param, 32, -1, 19, 0}
   , {E_Int_Param            , E_Expression_Param, 33, -1, 19, 0}
};

static const int GcontStateVarNum[AME_NBOF_EXPLICIT_STATE] = {
     11, 16, 22, 24, 115, 117, 119, 120
   , 121, 134, 142, 147
};
...
#define RP1 (&amesys->pModel->realParamArray[15])
#define IP1 (&amesys->pModel->integerParamArray[6])
#define RS2 (&amesys->pModel->realStoreArray[1])
#define RP2 (&amesys->pModel->realParamArray[17])
#define IP2 (&amesys->pModel->integerParamArray[7])
#define RS3 (&amesys->pModel->realStoreArray[2])
#define RP3 (&amesys->pModel->realParamArray[19])
#define IP3 (&amesys->pModel->integerParamArray[8])
#define RS4 (&amesys->pModel->realStoreArray[3])
#define IS4 (&amesys->pModel->intStoreArray[13])
#define RP4 (&amesys->pModel->realParamArray[21])
#define IP4 (&amesys->pModel->integerParamArray[9])
#define TP4 (&amesys->pModel->textParamArray[0])
#define RP7 (&amesys->pModel->realParamArray[32])
#define RP9 (&amesys->pModel->realParamArray[33])
#define IP9 (&amesys->pModel->integerParamArray[16])
#define RP10 (&amesys->pModel->realParamArray[35])
#define RS15 (&amesys->pModel->realStoreArray[6])
#define IS15 (&amesys->pModel->intStoreArray[20])
#define RP15 (&amesys->pModel->realParamArray[36])
#define IP15 (&amesys->pModel->integerParamArray[17])
#define TP15 (&amesys->pModel->textParamArray[2])
#define RP16 (&amesys->pModel->realParamArray[64])
#define IS17 (&amesys->pModel->intStoreArray[32])
#define RP17 (&amesys->pModel->realParamArray[65])
#define IP17 (&amesys->pModel->integerParamArray[27])
#define IS18 (&amesys->pModel->intStoreArray[37])
#define RP18 (&amesys->pModel->realParamArray[69])
#define IP18 (&amesys->pModel->integerParamArray[28])
#define IS19 (&amesys->pModel->intStoreArray[42])
#define RP19 (&amesys->pModel->realParamArray[73])
#define RS21 (&amesys->pModel->realStoreArray[16])
#define RP21 (&amesys->pModel->realParamArray[75])
#define IP21 (&amesys->pModel->integerParamArray[29])
#define RS22 (&amesys->pModel->realStoreArray[17])
#define IS22 (&amesys->pModel->intStoreArray[46])
#define RP22 (&amesys->pModel->realParamArray[77])
#define IP22 (&amesys->pModel->integerParamArray[30])
#define RS23 (&amesys->pModel->realStoreArray[26])
#define IS23 (&amesys->pModel->intStoreArray[49])
#define RP23 (&amesys->pModel->realParamArray[102])
#define IP23 (&amesys->pModel->integerParamArray[32])


static const S_AMEVariableInfo GVarInfo[AME_NB_VAR_INFO] = {
   { 0, 1, 1, 1, "MECRSS0B", "wsig" }
  ,{ 1, 1, 1, 2, "EBCT00", "vsig" }
  ,{ 2, 1, 1, 3, "EBCT00", "vsig" }
  ,{ 3, 1, 1, 1, "EBCT00", "vsig" }
  ,{ 4, 0, 1, 1, "EMDSCIMFOC01", "dc" }
  ,{ 5, 1, 1, 1, "EMDSCIMFOC01", "theta" }
  ,{ 6, 1, 1, 1, "EMDSCIMFOC01", "X" }
  ,{ 7, 1, 1, 1, "GA00", "output" }
  ,{ 8, 1, 1, 2, "UD00", "output" }
  ,{ 9, 1, 1, 1, "EMDSCIMFOC01", "wer" }
  ,{ 10, 1, 1, 1, "EMDSCIMFOC01", "wmrest2" }
  ,{ 11, 1, 1, 1, "EMDSCIMFOC01", "thetamrest" }
  ,{ 12, 1, 1, 1, "EMDSCIMFOC01", "Isdc" }
  ,{ 13, 1, 1, 1, "EMDSCIMFOC01", "Isdm" }
  ,{ 14, 1, 1, 1, "EMDSCIMFOC01", "Esdest" }
  ,{ 15, 1, 1, 1, "EMDSCIMFOC01", "ppartd" }
  ,{ 16, 1, 1, 1, "EMDSCIMFOC01", "ipartd" }
  ,{ 17, 1, 1, 1, "EMDSCIMFOC01", "Usd" }
  ,{ 18, 1, 1, 1, "EMDSCIMFOC01", "Isqc" }
  ,{ 19, 1, 1, 1, "EMDSCIMFOC01", "Isqm" }
  ,{ 20, 1, 1, 1, "EMDSCIMFOC01", "Esqest" }
  ,{ 21, 1, 1, 1, "EMDSCIMFOC01", "ppartq" }
  ,{ 22, 1, 1, 1, "EMDSCIMFOC01", "ipartq" }
  ,{ 23, 1, 1, 1, "EMDSCIMFOC01", "Usq" }
  ,{ 24, 1, 1, 1, "EMDSCIMFOC01", "Imrest" }
  ,{ 25, 0, 1, 1, "EMDSCIMFOC01", "Isdopt" }
  ,{ 26, 0, 1, 1, "EMDSCIMFOC01", "Isqmax" }
  ,{ 27, 1, 1, 1, "EMDSCIMFOC01", "Urmsmax" }
  ,{ 28, 1, 1, 1, "EMDSCIMFOC01", "Urmsmaxcc" }
  ,{ 29, 1, 1, 1, "EMDSCIMFOC01", "Irmsmaxtor" }
  ,{ 30, 1, 1, 1, "EMDSCIMFOC01", "Isdmaxtor" }
  ,{ 31, 1, 1, 1, "EMDSCIMFOC01", "Tmax" }
  ,{ 32, 1, 1, 1, "EMDSCIMFOC01", "Tmin" }
  ,{ 33, 0, 1, 1, "EMDSCIMFOC01", "IrmsmaxGEN" }
  ,{ 34, 0, 1, 1, "EMDSCIMFOC01", "IrmsmaxMOT" }
  ,{ 35, 0, 1, 1, "EMDSCIMFOC01", "IsdmaxGEN" }
  ,{ 36, 0, 1, 1, "EMDSCIMFOC01", "IsdmaxMOT" }
  ,{ 37, 1, 1, 1, "ESCAVINV001", "v1" }
  ,{ 38, 1, 1, 1, "EBCT00", "I1" }
  ,{ 39, 1, 1, 1, "EMDSCIM11", "I1" }
  ,{ 40, 1, 1, 1, "EBCT00", "V3" }
  ,{ 41, 1, 1, 1, "EBCT00", "U" }
  ,{ 42, 1, 1, 1, "EBCT00", "I" }
  ,{ 43, 1, 1, 1, "ESCAVINV001", "v3" }
  ,{ 44, 1, 1, 2, "EBCT00", "I1" }
  ,{ 45, 1, 1, 1, "EMDSCIM11", "I3" }
  ,{ 46, 1, 1, 2, "EBCT00", "V3" }
  ,{ 47, 1, 1, 2, "EBCT00", "U" }
  ,{ 48, 1, 1, 2, "EBCT00", "I" }
  ,{ 49, 1, 1, 1, "ESCAVINV001", "v2" }
  ,{ 50, 1, 1, 3, "EBCT00", "I1" }
  ,{ 51, 1, 1, 1, "EMDSCIM11", "I2" }
  ,{ 52, 1, 1, 3, "EBCT00", "V3" }
  ,{ 53, 1, 1, 3, "EBCT00", "U" }
  ,{ 54, 1, 1, 3, "EBCT00", "I" }
  ,{ 55, 1, 1, 1, "THTS1", "t1" }
  ,{ 56, 1, 1, 1, "ESCAVINV001", "dh" }
  ,{ 57, 1, 1, 1, "EB3N03", "V2" }
  ,{ 58, 1, 1, 1, "ESCAVINV001", "idc1" }
  ,{ 59, 1, 1, 1, "EB4N04", "V1" }
  ,{ 60, 1, 1, 1, "ESCAVINV001", "idc2" }
  ,{ 61, 1, 1, 1, "ESCAVINV001", "Uin" }
  ,{ 62, 1, 1, 1, "ESCAVINV001", "Iin" }
  ,{ 63, 1, 1, 1, "ESCAVINV001", "Urms" }
  ,{ 64, 1, 1, 1, "ESCAVINV001", "Irms" }
  ,{ 65, 1, 1, 1, "ESCAVINV001", "pf" }
  ,{ 66, 1, 1, 1, "ESCAVINV001", "P" }
  ,{ 67, 1, 1, 1, "ESCAVINV001", "S" }
  ,{ 68, 1, 1, 1, "ESCAVINV001", "UrmsMax" }
  ,{ 69, 1, 1, 1, "ESCAVINV001", "XI" }
  ,{ 70, 1, 1, 1, "ESCAVINV001", "XII" }
  ,{ 71, 1, 1, 1, "ESCAVINV001", "XIII" }
  ,{ 72, 1, 1, 1, "ESCAVINV001", "dhtc" }
  ,{ 73, 1, 1, 1, "ESCAVINV001", "dhdc" }
  ,{ 74, 1, 1, 1, "ESCAVINV001", "dhsw" }
  ,{ 75, 1, 1, 1, "ESCAVINV001", "Vn" }
  ,{ 76, 0, 1, 1, "ESCAVINV001", "Esw" }
  ,{ 77, 0, 1, 1, "ESCAVINV001", "UrmsReqSat" }
  ,{ 78, 0, 1, 1, "ESCAVINV001", "Mv" }
  ,{ 79, 1, 1, 1, "ESCAVINV001", "effCalcul" }
  ,{ 80, 0, 1, 1, "ESCAVINV001", "powerRSelec" }
  ,{ 81, 1, 1, 1, "EB4N04", "V3" }
  ,{ 82, 1, 1, 1, "EBVS01", "I1" }
  ,{ 83, 1, 1, 1, "EB3N03", "I3" }
  ,{ 84, 1, 1, 1, "EBVS01", "V2" }
  ...
  ,{ 86, 1, 1, 1, "EBVS01", "U" }
  ,{ 87, 1, 1, 1, "EBVS01", "I" }
  ,{ 88, 1, 1, 1, "CONS00", "k0GEN" }
  ,{ 89, 1, 1, 1, "EBVT01", "I3" }
  ,{ 90, 1, 1, 1, "EB3N03", "V1" }
  ,{ 91, 1, 1, 1, "EB4N04", "V2" }
  ,{ 92, 1, 1, 1, "EBVT01", "I1" }
  ,{ 93, 1, 1, 1, "EBVT01", "vsig" }
  ,{ 94, 1, 1, 1, "EBVT01", "U" }
  ,{ 95, 1, 1, 1, "EBVT01", "I" }
  ,{ 96, 1, 1, 1, "GA00", "k0GEN" }
  ,{ 97, 1, 1, 1, "EBZV01", "V1" }
  ,{ 98, 1, 1, 1, "EB4N04", "I4" }
  ,{ 99, 1, 1, 1, "EMDSCIM11", "torqstat" }
  ,{ 100, 1, 1, 1, "W000", "wzero" }
  ,{ 101, 1, 1, 1, "W000", "theta" }
  ,{ 102, 1, 1, 1, "EMDSCIM11", "dh" }
  ,{ 103, 1, 1, 2, "THTS1", "t1" }
  ,{ 104, 1, 1, 1, "RN001", "w1" }
  ,{ 105, 1, 1, 1, "EMDSCIM11", "torqrot" }
  ,{ 106, 1, 1, 1, "EMDSCIM11", "UsA" }
  ,{ 107, 1, 1, 1, "EMDSCIM11", "IsA" }
  ,{ 108, 1, 1, 1, "EMDSCIM11", "UsB" }
  ,{ 109, 1, 1, 1, "EMDSCIM11", "IsB" }
  ,{ 110, 1, 1, 1, "EMDSCIM11", "UsC" }
  ,{ 111, 1, 1, 1, "EMDSCIM11", "IsC" }
  ,{ 112, 1, 1, 1, "EMDSCIM11", "Vneutral" }
  ,{ 113, 1, 1, 1, "EMDSCIM11", "wdif" }
  ,{ 114, 1, 1, 1, "EMDSCIM11", "Tem" }
  ,{ 115, 1, 1, 1, "EMDSCIM11", "thetaer" }
  ,{ 116, 1, 1, 1, "EMDSCIM11", "Usd" }
  ,{ 117, 1, 1, 1, "EMDSCIM11", "Isd" }
  ,{ 118, 1, 1, 1, "EMDSCIM11", "Usq" }
  ,{ 119, 1, 1, 1, "EMDSCIM11", "Isq" }
  ,{ 120, 1, 1, 1, "EMDSCIM11", "Irdp1" }
  ,{ 121, 1, 1, 1, "EMDSCIM11", "Irqp1" }
  ,{ 122, 1, 1, 1, "EMDSCIM11", "Rs" }
  ,{ 123, 1, 1, 1, "EMDSCIM11", "Rrp1" }
  ,{ 124, 1, 1, 1, "EMDSCIM11", "Lm" }
  ,{ 125, 1, 1, 1, "EMDSCIM11", "Im" }
  ,{ 126, 1, 1, 1, "EMDSCIM11", "Ks" }
  ,{ 127, 1, 1, 1, "EMDSCIM11", "dKs" }
  ,{ 128, 0, 1, 1, "EMDSCIM11", "powerRSelec" }
  ,{ 129, 0, 1, 1, "EMDSCIM11", "powerIelec" }
  ,{ 130, 1, 1, 1, "EMDSCIM11", "det" }
  ,{ 131, 1, 1, 1, "MECRL0", "wdup" }
  ,{ 132, 1, 1, 1, "RN001", "t2" }
  ,{ 133, 1, 1, 1, "RSD00", "to1" }
  ,{ 134, 1, 1, 1, "MECRL0", "w" }
  ,{ 135, 1, 1, 1, "MECRL0", "accel" }
  ,{ 136, 1, 1, 1, "MECRL0", "Tvisc" }
  ,{ 137, 0, 1, 1, "MECRL0", "powerRfrict" }
  ,{ 138, 0, 1, 1, "MECRL0", "powerIrmass" }
  ,{ 139, 1, 1, 1, "RSD00", "t2" }
  ,{ 140, 1, 1, 2, "MECRL0", "wdup" }
  ,{ 141, 1, 1, 1, "MECRSS0B", "tordup" }
  ,{ 142, 1, 1, 2, "MECRL0", "w" }
  ,{ 143, 1, 1, 2, "MECRL0", "accel" }
  ,{ 144, 1, 1, 2, "MECRL0", "Tvisc" }
  ,{ 145, 0, 1, 2, "MECRL0", "powerRfrict" }
  ,{ 146, 0, 1, 2, "MECRL0", "powerIrmass" }
  ,{ 147, 1, 1, 1, "RSD00", "are" }
  ,{ 148, 0, 1, 1, "RSD00", "powerCrspring" }
  ,{ 149, 0, 1, 1, "RSD00", "powerRrdamp" }
  ,{ 150, 1, 1, 1, "RSD00", "tspring" }
  ,{ 151, 1, 1, 1, "RSD00", "tdamper" }
  ,{ 152, 1, 1, 1, "UD00", "output" }
  ,{ 153, 1, 1, 1, "MECRSS0B", "wdup" }
  ,{ 154, 1, 1, 1, "TORQC", "torque" }
};
...
#ifdef AMERT
double IL_12_VectorControl_step_ratio=0;
#endif

#ifdef AME_MEMORY_ACCESS_RT_EXPORT
#include "12_VectorControl_.export.h"
#endif

#ifdef AME_INPUT_IN_MEMORY
#include "12_VectorControl_.sim.h"
#endif
...
extern void emdscimfoc01in_(int *n, double *RP, int *IP, int *IS
                 , double *y0, double *y1, double *y2, double *y3
                   , double *y4, double *y5, double *y6);
extern void emdscimfoc01_(int *n, double *port_1_v1, double *port_2_v1
                   , double *port_3_v1, double *port_4_v1, double *port_6_v1
                   , double *port_7_v1, double *port_8_v1, double *port_9_v1
                   , double *int_v1, double *int_v2, double *int_v3
                   , double *int_dv3, double *int_v4, double *int_v5
                   , double *int_v6, double *int_v7, double *int_v8
                   , double *int_dv8, double *int_v9, double *int_v10
                   , double *int_v11, double *int_v12, double *int_v13
                   , double *int_v14, double *int_dv14, double *int_v15
                   , double *int_v16, double *int_dv16, double *int_v17
                   , double *int_v18, double *int_v19, double *int_v20
                   , double *int_dv20, double *int_v21, double *int_v22
                   , double *int_v23, double *int_v24, double *int_v25
                   , double *int_dv25, double *int_v26, double *int_v27
                   , double *int_v28, double *int_v29, double *int_v30
                   , double *int_v31, double *RP, int *IP, int *IS
                 , int *flag);
extern double emdscimfoc01_wer_(int *n, double *m0, double *RP
                 , int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_Urmsmax_(int *n, double *m0, double *RP
                 , int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_Urmsmaxcc_(int *n, double *m0, double *RP
                 , int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_Tmax_(int *n, double *m0, double *m1
              , double *m2, double *m3, double *m4, double *RP
                 , int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_Tmin_(int *n, double *m0, double *m1
              , double *m2, double *m3, double *m4, double *RP
                 , int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_IrmsmaxGEN_(int *n, double *m0, double *m1
              , double *RP, int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_IrmsmaxMOT_(int *n, double *m0, double *m1
              , double *RP, int *IP, int *IS, int *flag, int *macindex
                   );
extern double emdscimfoc01_IsdmaxGEN_(int *n, double *m0, double *m1
              , double *m2, double *RP, int *IP, int *IS, int *flag
                   , int *macindex);
extern double emdscimfoc01_IsdmaxMOT_(int *n, double *m0, double *m1
              , double *m2, double *RP, int *IP, int *IS, int *flag
                   , int *macindex);
...
extern void escavinv001in_(int *n, double *RP, int *IP, char **TP
                 , double *RS, int *IS, double *y0, double *y1
                   );
extern void escavinv001_(int *n, double *ve0, double *ve1, double *ve2
                   ...
                   , double *vi17, double *vi18, double *vi19
                   , double *vi20, double *vi21, double *vi22
                   , double *vi23, double *vi24, double *vi25
                   , double *vi26, double *vi27, double *vi28
                   , double *vi29, double *vi30, double *vidot30
                   , double *vi31, double *vi32, double *vidot32
                   , double *RP, int *IP, char **TP, double *RS
                 , int *IS, int *flag);
extern double escavinv001_macro0_(int *n, double *m0, double *m1
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *flag);
extern double escavinv001_macro1_(int *n, double *m0, double *m1
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *flag);
extern double escavinv001_macro2_(int *n, double *m0, double *m1
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *flag);
extern double escavinv001_macro3_(int *n, double *m0, double *m1
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *flag);
extern double escavinv001_macro4_(int *n, double *m0, double *m1
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *flag);
extern double escavinv001_macro5_(int *n, double *m0, double *m1
              , double *m2, double *m3, double *m4, double *m5
              , double *m6, double *RP, int *IP, char **TP, double *RS
                 , int *IS, int *flag);
extern double escavinv001_macro6_(int *n, double *m0, double *m1
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *flag);
extern double escavinv001_macro7_(int *n, double *m0, double *m1
...
extern void ga00_(int *n, double *ve0, double *ve1, double *vi2
                   , double *RP, int *flag);
extern void eb4n04in_(int *n);
extern void ebzv01in_(int *n, double *y0);
extern void w000in_(int *n, double *y0, double *y1);
extern void emdscim11in_(int *n, double *RP, int *IP, char **TP
                 , double *RS, int *IS, double *y0, double *y1
                   ...
                   , double *y14);
extern void emdscim11_(int *n, double *port_1_v1, double *port_1_v2
                   , double *port_2_v1, double *port_2_v2, double *port_3_v1
                   , double *port_3_v2, double *port_4_v2, double *port_5_v1
                   , double *port_5_v2, double *port_6_v2, double *int_v1
                   ...
                   , double *int_dv10, double *int_v11, double *int_v12
                   , double *int_dv12, double *int_v13, double *int_v14
                   , double *int_dv14, double *int_v15, double *int_dv15
                   , double *int_v16, double *int_dv16, double *int_v17
                   , double *int_dv17, double *int_v18, double *int_dv18
                   , double *int_v19, double *int_dv19, double *int_v20
                   , double *int_dv20, double *int_v21, double *int_v22
                   , double *int_v23, double *int_v24, double *int_v25
                   , double *int_v26, double *int_v27, double *int_v28
                   , double *int_v29, double *int_dv29, double *int_v30
                   , double *int_v31, double *int_dv31, double *int_v32
                   , double *int_dv32, double *int_v33, double *int_v34
                   , double *int_dv34, double *int_v35, double *int_dv35
                   , double *int_v36, double *int_dv36, double *int_v37
                   , double *int_v38, double *int_v39, double *int_v40
                   , double *int_v41, double *RP, int *IP, char **TP
                 , double *RS, int *IS);
extern double emdscim11_I1_(int *n, double *m0, double *m1, double *m2
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *macindex);
extern double emdscim11_I2_(int *n, double *m0, double *m1, double *m2
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *macindex);
extern double emdscim11_I3_(int *n, double *m0, double *m1, double *m2
              , double *RP, int *IP, char **TP, double *RS, int *IS
                 , int *macindex);
extern double emdscim11_wdif_(int *n, double *m0, double *m1, double *RP
...
static void Initialize(AMESIMSYSTEM *amesys, double *y)
{
   ...
   n = 1;
   w000in_(&n, &v[100], &v[101]);

   n = 2;
   thts1in_(&n, &v[103]);

   n = 1;
   ud00in_(&n, RP22, IP22, RS22, IS22);

   n = 2;
   ud00in_(&n, RP23, IP23, RS23, IS23);

   n = 1;
   ebvt01in_(&n, RP9, IP9, &v[92], &v[89], &v[95]);
   ...
   n = 1;
   rsd00in_(&n, RP19, IS19, &y[11], NULL, NULL, NULL, NULL);

   n = 1;
   mecrss0bin_(&n, RP21, IP21, RS21);

   n = 2;
   mecrl0in_(&n, RP18, IP18, IS18, &y[10], NULL, NULL, NULL, NULL
      );
   ...
   n = 1;
   {
      ...
      emdscimfoc01in_(&n, RP0, IP0, IS0, &v[4], &y[0], &y[1], &y[2]
         , &y[3], NULL, NULL);
   }

   n = 1;
   escavinv001in_(&n, RP4, IP4, TP4, RS4, IS4, NULL, NULL);

   n = 1;
   eb3n03in_(&n);

   n = 1;
   ebct00in_(&n, RP1, IP1, RS1, &v[41]);

   n = 2;
   ebct00in_(&n, RP2, IP2, RS2, &v[47]);

   n = 3;
   ebct00in_(&n, RP3, IP3, RS3, &v[53]);
   ...
   n = 1;
   {
      ...
      emdscim11in_(&n, RP15, IP15, TP15, RS15, IS15, &y[4], &y[5]
         , &y[6], &y[7], &y[8], NULL, NULL, NULL, NULL, NULL, NULL
         , NULL, NULL, NULL, NULL);
   }
   ...
   n = 1;
   mecrl0in_(&n, RP17, IP17, IS17, &y[9], NULL, NULL, NULL, NULL
      );
...
static void localFuncEval(AMESIMSYSTEM *amesys, double t, double *y, double *yprime, double *delta, int *flag)
{
   ...
   *oldflag = *newflag = sflag;
   ...
   n = 1;
   *oldflag = *newflag = sflag;
   cons00_(&n, &v[85], &v[88], RP7, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"CONS00",1);

   v[59] = v[97] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[91] = v[97] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[81] = v[97] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[39] = emdscim11_I1_(&n, &v[115], &v[117], &v[119], RP15
         , IP15, TP15, RS15, IS15, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIM11",1);

   n = 1;
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[51] = emdscim11_I2_(&n, &v[115], &v[117], &v[119], RP15
         , IP15, TP15, RS15, IS15, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIM11",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[45] = emdscim11_I3_(&n, &v[115], &v[117], &v[119], RP15
         , IP15, TP15, RS15, IS15, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIM11",1);
   ...
   n = 1;
   *oldflag = *newflag = sflag;
   ud00_(&n, &v[152], RP22, IP22, RS22, IS22, &sflag, &t);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"UD00",1);

   n = 2;
   *oldflag = *newflag = sflag;
   ud00_(&n, &v[8], RP23, IP23, RS23, IS23, &sflag, &t);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"UD00",2);

   v[38] = v[39] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[3] = -RP1[1]*(RS1[0]*v[39]-RP1[0]);
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[44] = v[45] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[1] = -RP2[1]*(RS2[0]*v[45]-RP2[0]);
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[50] = v[51] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[2] = -RP3[1]*(RS3[0]*v[51]-RP3[0]);
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[84] = v[85]+v[81];
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[90] = v[84] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[57] = v[84] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   n = 1;
   *oldflag = *newflag = sflag;
   ebvt01_(&n, &v[91], &v[93], &v[90], &v[94], RP9, IP9);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EBVT01",1);

   n = 1;
   *oldflag = *newflag = sflag;
   ga00_(&n, &v[7], &v[93], &v[96], RP10, &sflag);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[27] = emdscimfoc01_Urmsmax_(&n, &v[7], RP0, IP0, IS0, &sflag
             , &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);

   n = 1;
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[28] = emdscimfoc01_Urmsmaxcc_(&n, &v[7], RP0, IP0, IS0
         , &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   n = 1;
   *oldflag = *newflag = sflag;
   v[61] = escavinv001_macro0_(&n, &v[57], &v[59], RP4, IP4, TP4
         , RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[68] = escavinv001_macro1_(&n, &v[57], &v[59], RP4, IP4, TP4
         , RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   v[131] = -v[134] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[140] = -v[142] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   n = 1;
   *oldflag = *newflag = sflag;
   rsd00_(&n, &v[133], &v[134], &v[140], &v[147], &dot[11], NULL
      , NULL, &v[148], NULL, NULL, NULL, NULL, &v[149], NULL, NULL
      , &v[150], &v[151], RP19, IS19);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"RSD00",1);

   v[139] = v[133] /* Duplicate variable. */;
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);

   v[0] = RP21[1]*(RS21[0]*v[142]-RP21[0]);
   AME_POST_SUBMODCALL_NO_DISCON(amesys,flag);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[9] = emdscimfoc01_wer_(&n, &v[0], RP0, IP0, IS0, &sflag
             , &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[33] = emdscimfoc01_IrmsmaxGEN_(&n, &v[9], &v[27], RP0
         , IP0, IS0, &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[34] = emdscimfoc01_IrmsmaxMOT_(&n, &v[9], &v[27], RP0
         , IP0, IS0, &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[35] = emdscimfoc01_IsdmaxGEN_(&n, &v[9], &v[27], &v[33]
      , RP0, IP0, IS0, &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[36] = emdscimfoc01_IsdmaxMOT_(&n, &v[9], &v[27], &v[34]
      , RP0, IP0, IS0, &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   n = 2;
   *oldflag = *newflag = sflag;
   mecrl0_(&n, &v[139], &v[142], &dot[10], &v[141], &v[143], &v[144]
      , NULL, NULL, &v[145], NULL, NULL, NULL, NULL, &v[146], NULL
      , NULL, RP18, IP18, IS18);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[31] = emdscimfoc01_Tmax_(&n, &v[9], &v[33], &v[34], &v[35], &v[36]
      , RP0, IP0, IS0, &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[32] = emdscimfoc01_Tmin_(&n, &v[9], &v[33], &v[34], &v[35], &v[36]
      , RP0, IP0, IS0, &sflag, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK macro start. */
      int izero = 0;
      v[113] = emdscim11_wdif_(&n, &v[104], &v[100], RP15, IP15
         , TP15, RS15, IS15, &izero);
   }  /* DBK macro end. */
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIM11",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK specific start. */
      ...
      emdscimfoc01_(&n, &v[0], &v[1], &v[2], &v[3], &v[5], &v[6]
      , &v[7], &v[8], &v[9], &v[10], &v[11], &dot[0], &v[12], &v[13]
      , &v[14], &v[15], &v[16], &dot[1], &v[17], &v[18], &v[19]
      , &v[20], &v[21], &v[22], &dot[2], &v[23], &v[24], &dot[3]
      , &v[25], &v[26], NULL, NULL, NULL, &v[27], &v[28], &v[29]
      , &v[30], NULL, NULL, &v[31], &v[32], &v[33], &v[34], &v[35]
      , &v[36], RP0, IP0, IS0, &sflag);
   }
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIMFOC01",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[77] = escavinv001_macro6_(&n, &v[6], &v[61], RP4, IP4, TP4
         , RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[69] = escavinv001_macro2_(&n, &v[5], &v[77], RP4, IP4, TP4
         , RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[70] = escavinv001_macro3_(&n, &v[5], &v[77], RP4, IP4, TP4
         , RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[71] = escavinv001_macro4_(&n, &v[5], &v[77], RP4, IP4, TP4
         , RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[78] = escavinv001_macro7_(&n, &v[69], &v[70], &v[71], RP4
         , IP4, TP4, RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   v[75] = escavinv001_macro5_(&n, &v[5], &v[57], &v[59], &v[69], &v[70], &v[71], &v[78]
   , RP4, IP4, TP4, RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);

   n = 1;
   *oldflag = *newflag = sflag;
   escavinv001_(&n, &v[6], &v[5], &v[44], &v[50], &v[38], &v[56]
      , &v[55], &v[58], &v[57], &v[60], &v[59], &v[61], &v[62]
      , &v[63], &v[64], &v[65], &v[66], &v[67], &v[68], &v[69]
      , &v[70], &v[71], &v[72], &v[73], &v[74], &v[75], &v[76]
      , &v[77], &v[78], &v[79], NULL, NULL, &v[80], NULL, NULL
      , RP4, IP4, TP4, RS4, IS4, &sflag);
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"ESCAVINV001",1);
   ...
   *oldflag = *newflag = sflag;
   {  /* DBK specific start. */
      ...
      emdscim11_(&n, &v[39], &v[40], &v[51], &v[52], &v[45], &v[46]
      , &v[104], &v[102], &v[103], &v[100], &v[106], &v[107], &v[108]
      , &v[109], &v[110], &v[111], &v[112], &v[113], &v[114], &v[115]
      , &dot[4], &v[116], &v[117], &dot[5], &v[118], &v[119], &dot[6]
      , &v[120], &dot[7], &v[121], &dot[8], NULL, NULL, NULL, NULL
      , NULL, NULL, NULL, NULL, &v[122], &v[123], NULL, NULL, &v[124]
      , &v[125], &v[126], &v[127], NULL, NULL, &v[128], NULL, NULL
      , NULL, NULL, &v[129], NULL, NULL, NULL, NULL, NULL, NULL
      , NULL, NULL, NULL, NULL, &v[130], RP15, IP15, TP15, RS15
      , IS15);
   }
   AME_POST_SUBMODCALL_WITH_DISCON(amesys,flag,&sflag,&oflag,&panic,"EMDSCIM11",1);
   ...
   n = 1;
   *oldflag = *newflag = sflag;
   mecrl0_(&n, &v[132], &v[134], &dot[9], &v[133], &v[135], &v[136]
      , NULL, NULL, &v[137], NULL, NULL, NULL, NULL, &v[138], NULL
      , NULL, RP17, IP17, IS17);
...
#ifdef AME_INPUT_IN_MEMORY
#include "12_VectorControl_.ssf.h"
...
#include "12_VectorControl_.subdata.h"
#endif
...
#ifdef AME_INPUT_IN_MEMORY
#include "12_VectorControl_.globalparams.h"
#endif
...
{  
#include "12_VectorControl_.data.h"
...
{
#ifdef AME_INPUT_IN_MEMORY
#include "12_VectorControl_.lock.h"
...
static int ameInitializeConditionsFixed(AMESIMSYSTEM *amesys)
{
   ...
   {
   static int num_fixed = 12;
   static int FIXED[12] = {4, 41, 47, 53, 55, 92, 89, 95, 97, 100
                        , 101, 103};
...
static AMESystemError AmesysInstantiate(AMESIMSYSTEM **amesysPtr)
{
   ...
   if(result == AME_NO_ERROR) {
      if( (jump_ret = setjmp(amesys->jump_env)) == 0) { /* ~try */ 
         ...
         AmeSetModelBaseName(amesys,"12_VectorControl_", NULL);
...
static void doAFixedStep(AMESIMSYSTEM *amesys, double time)
{
   ...
   {
      double localstepratio=floor(IL_12_VectorControl_step_ratio);
      if (localstepratio >= 1) 
      {
...
#define SYSNME 12_VectorControl_
...
#define AMEVERISTAND_LOG_FILE "c:\\temp\\NIV_12_VectorControl_.log"
#include "NIV_model.c"
#endif
