...
<PLT DOC_VERSION="16.0.0">
    <PLOT_CFG>
        <WINDOW_GEOMETRY>697 331 515 313</WINDOW_GEOMETRY>
        <ITEMS_LIST>
            <ITEM type="dpv">
                <UNIT>s</UNIT>
                <NAME>A0</NAME>
            ...
            <AREAS_LIST>
                <AREA>
                    ...
                    <GRAPH_TITLES_CONFIGURATION>
                        ...
                        <LEGEND_POSITION>5</LEGEND_POSITION>
